...
## Description
An elegant and responsive profile template that anyone can use and apply their own styling to.  There are lots of neat hover effects throughout the project, such as project cards that flip to reveal individual contributions, a crooked picture that is straightened when hovered, and pagination carousel.
...
## Installation
Node, NPM, React, React Icons, Email-js, Swiper
